...
select case strSort
	...
	response.write "<TH align=left><font size=2><a href='ROList.asp?ShopID=" & ishopid & "&Month=" & drptmonth & "&Sort=LastCall'>Last Call</a></TH>"
	...
	If (ParentID = 77 or Name = "Gerber" or MSO=-1) then 'use Gerber
	    ...
	    strURL = "http://www.csicomplete.com/reports_collision/DetailPagecaliber.asp?jobid=" & rsdetail.fields("jobid") & "&ShopID=" & ishopid & " "
	    case 2
