...
if rsdetail.eof then
	...
	response.write "<TH align=right width=""60""><font size=2>2nd Visit</TH>"
	...
	do until rsdetail.eof
		...
		response.write "<td align=center><font size=2 color=red>" & left(rsdetail.fields("RecShopNum"),4) & "</td>"
