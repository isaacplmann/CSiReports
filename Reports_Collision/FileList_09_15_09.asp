...
Name = session("sessionname")
	If (ParentID = 77 or Name = "Gerber" or MSO=-1) then 'use Gerber survey
             Response.Write "<a href=""javascript: openZoom2('http://www.csicomplete.com/reports_gerber/survey_mso.htm','Survey');""><img src =""http://www.csicomplete.com/images/surimg2.jpg"" border =0><font style=""FONT-FAMILY: sans-serif"" fontsize=2><b>Survey</b></font></a>" 
    Else
	...
	case "S"
		...
		<%
			...
			do until rsreport.EOF
				...
				ParentID = session("sessionparentid")
				MSO = session("sessionmso")
	            If ParentID = 77 Or MSO=-1 then 'use Gerber survey
                         Response.Write "<a href=/reports_collision/trendgerber.asp?shopid=" & session("shopid") & " target=""SCREEN"">Trend Report</a>"
                Else
				select case session("surveytypeid")
					case 2
