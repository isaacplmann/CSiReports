...
strdetail = "select sum(ROs) as ROs, " & _
	" (sum(convert(float(2),QualityQ)*[ROS])/(sum([ROs]))) as Quality, " & _
...
if rsdetail.eof then
	...
	response.write "<TH align=left width=""80""><font size=2>Comm</TH>"
	response.write "<TH align=left width=""80""><font size=2>Time</TH>"
	response.write "<TH align=left width=""80""><font size=2>2nd Visit</TH>"
	...
	do until rsdetail.eof
		...
		response.write "<td align=left><font size=2>" & left(rsdetail.fields("RecShopNum"),4) & "</td>"
		response.write "<td align=left><font size=2>" & left(rsdetail.fields("Quality"),4) & "</td>"
		response.write "<td align=left><font size=2>" & left(rsdetail.fields("Comm"),4) & "% </td>"
		response.write "<td align=left><font size=2>" & left(rsdetail.fields("OnTime"),4) & "% </td>"
		response.write "<td align=left><font size=2>" & left(rsdetail.fields("ReturnVisit"),4) & "% </td>"		
