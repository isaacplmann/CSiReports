...
select case strSort
	...
	response.write "<TABLE width=""100%"">"
	response.write "<TH align=left><font size=2><a href='ROList.asp?ShopID=" & ishopid & "&Month=" & drptmonth & "&Sort=Status'>Status</a></TH>"
	response.write "<TH align=center><font size=2><a href='ROList.asp?ShopID=" & ishopid & "&Month=" & drptmonth & "&Sort=RO'>RO</a></TH>"
	response.write "<TH align=left><font size=2>View</TH>"
	response.write "<TH align=left><font size=2><a href='ROList.asp?ShopID=" & ishopid & "&Month=" & drptmonth & "&Sort=Last'>Last</a></TH>"
	response.write "<TH align=left><font size=2><a href='ROList.asp?ShopID=" & ishopid & "&Month=" & drptmonth & "&Sort=First'>First</a></TH>"
	response.write "<TH align=left><font size=2><a href='ROList.asp?ShopID=" & ishopid & "&Month=" & drptmonth & "&Sort=CSi'>CSi</a></TH>"
	response.write "<TH align=left><font size=2><a href='ROList.asp?ShopID=" & ishopid & "&Month=" & drptmonth & "&Sort=RecShopNum'>0 - 10</a></TH>"
	response.write "<TH align=left><font size=2><a href='ROList.asp?ShopID=" & ishopid & "&Month=" & drptmonth & "&Sort=HS'>Hot Sheet</a></TH>"
	response.write "<TH align=left><font size=2><a href='ROList.asp?ShopID=" & ishopid & "&Month=" & drptmonth & "&Sort=SW'>Estimator</a></TH>"
	response.write "<TH align=left><font size=2><a href='ROList.asp?ShopID=" & ishopid & "&Month=" & drptmonth & "&Sort=LastCall'>Last Connected Call</a></TH>"
	response.write "<TH align=left><font size=2><a href='ROList.asp?ShopID=" & ishopid & "&Month=" & drptmonth & "&Sort=Ins'>Insurer</a></TH>"
	response.write "</tr>"
	...
	If (ParentID = 77 or Name = "Gerber" or MSO=-1) then 'use Gerber
	    ...
	    strURL = "http://www.csicomplete.com/reports_collision/detailpagemso.asp?jobid=" & rsdetail.fields("jobid") & "&ShopID=" & ishopid & " "
	    case 2
	...
	Else
	    ...
	    case 1
	    pic="<IMG Style = ""WIDTH: 15px; HEIGHT: 15px"" height=44 hspace=1 src=""http://www.csicomplete.com/images/green.gif"" vspace=1 border=0>"
	    strURL = "http://www.csicomplete.com/reports_collision/DetailPage.asp?jobid=" & rsdetail.fields("jobid") & "&ShopID=" & ishopid & " "
	    case 2
	    pic="<IMG Style = ""WIDTH: 15px; HEIGHT: 15px"" height=44 hspace=1 src=""http://www.csicomplete.com/images/yellow.gif"" vspace=1 border=0>"
	    strURL = "http://www.csicomplete.com/reports_collision/DetailPageInc.asp?jobid=" & rsdetail.fields("jobid") & "&ShopID=" & ishopid & " "
	    Case else
