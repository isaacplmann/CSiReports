...
select case session("clienttype")
	...
	case "S"
		...
		<%
			strReport = "select ReportName, ReportASP, ReportMonth from tblCollisionReports where (CollisionID=" & session("id") & ") and (active <>'0') and (CollisionReportID=1 or CollisionReportID=15 or CollisionReportID=27 or CollisionReportID=33) order by ReportMonth desc"
