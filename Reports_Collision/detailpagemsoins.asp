...
strDetail = "select tblCollisionDetail.FirstName,tblCollisionDetail.LastName,tblCollisionDetail.RO,tblCollisionDetail.homephone,tblCollisionDetail.workphone,tblCollisionDetail.insurer, " & _
	" tblCollisionDetail.hotsheetdate,tblCollisionDetail.lastcall,tblCollisionDetailAll.claimq,tblCollisionDetailAll.recinsq,tblCollisionDetailAll.rolledover,tblCollisionDetailAll.recshopnum, " & _
	" tblCollisionDetailAll.referral,tblCollisionDetailAll.QualityQ,tblCollisionDetailAll.QualityB,tblCollisionDetailAll.QualityC, " & _
	" tblCollisionDetailAll.InsuranceQ,tblCollisionDetailAll.InsuranceC, tblCollisionDetailAll.amount, " & _
	" tblCollisionDetailAll.year,tblCollisionDetailAll.make,tblCollisionDetailAll.detailq,tblCollisionDetailAll.detailb,tblCollisionDetailAll.detailc, " & _
	" tblCollisionDetailAll.commq,tblCollisionDetailAll.commb,tblCollisionDetailAll.commc,tblCollisionDetailAll.ontimeq,tblCollisionDetailAll.ontimeb,tblCollisionDetailAll.ontimec, " & _
	" tblCollisionDetailAll.returnq,tblCollisionDetailAll.returnb,tblCollisionDetailAll.returnc,tblCollisionDetailAll.recshopq,tblCollisionDetailAll.recshopc,tblCollisionDetailAll.comments " & _
	" from tblCollisionDetailAll inner join tblCollisionDetail on tblCollisionDetailAll.JobID=tblCollisionDetail.JobID where tblCollisionDetail.JobID=" & jobid & " "
set rsdetail=server.createobject("adodb.recordset")
rsDetail.open strDetail,cnlist
...
<td><font size=2>2. Insurance</font></td>
    <td valign=top><font size=2><b>
      <%Response.write rsdetail.Fields("InsuranceQ")%>
      </b></font></td>
<td valign=top></td>
<td valign=top><font size=2 color=red><%Response.write rsdetail.Fields("InsuranceC")%></font></td>
</tr>
<tr valign=top>
...
<td><font size=2>3. Quality</font></td>
    <td valign=top><font size=2><b>
      <%Response.write rsdetail.Fields("QualityQ")%>
      </b></font></td>
<td valign=top><font size=2 color=red><%Response.write rsdetail.Fields("QualityB")%></font></td>
<td valign=top><font size=2 color=red><%Response.write rsdetail.Fields("QualityC")%></font></td>
</tr>
<tr valign=top>
...
<td><font size=2>4. Informed</font></td>
...
<td><font size=2>5. On Time</font></td>
...
<td><font size=2>6. <font size=2>2nd Return Visit</font></font></td>
...
<td colspan=4><font size=2 color=red><%Response.write rsdetail.Fields("comments")%></font></td>
</tr>
<%Response.Flush%>
</table>
<%
...
<center>
    ...
    please call (800) 343-0641. Copyright 2012 CSi Complete</font></B></I> </em></strong>
</center>
</body></html>
