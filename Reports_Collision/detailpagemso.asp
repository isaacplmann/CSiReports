...
strDetail = "select tblCollisionDetail.FirstName,tblCollisionDetail.LastName,tblCollisionDetail.RO,tblCollisionDetail.homephone,tblCollisionDetail.workphone,tblCollisionDetail.insurer, " & _
	...
	" tblCollisionDetailAll.referral,tblCollisionDetailAll.bodyq,tblCollisionDetailAll.Body,tblCollisionDetailAll.bodyb,tblCollisionDetailAll.bodyc,tblCollisionDetailAll.paintq, " & _
	" tblCollisionDetailAll.Paint,tblCollisionDetailAll.paintb,tblCollisionDetailAll.paintc,tblCollisionDetailAll.amount,tblCollisionDetailAll.mechq,tblCollisionDetailAll.mechb, " & _
	" tblCollisionDetailAll.mechc,tblCollisionDetailAll.year,tblCollisionDetailAll.make,tblCollisionDetailAll.detailq,tblCollisionDetailAll.detailb,tblCollisionDetailAll.detailc, " & _
...
<td><font size=2>2. Quality - Body</font></td>
    <td valign=top><font size=2><b>
      <%if rsdetail.Fields("bodyq")=-1 then Response.write "YES" else Response.write "NO"%>
      </b></font></td>
